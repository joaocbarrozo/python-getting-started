...
from .views import abaixo_est_min_view, add_produto_pedido_view, compras_view, dashboard_view, detalhes_compra_view, detalhes_pedido_view, editar_fornecedor_view, editar_pedido_view, editar_produto_view, fornecedores_view, itensImportados_view, login_view, home_view, pedidos_view, produtos_view, logout_view, relatorio_consumo_view, remover_fornecedor_view, remover_produto_pedido_view, entradas_view, add_entrada_view, saidas_view, add_saida_view
...
urlpatterns = [
    ...
    path('itens_importados/', itensImportados_view, name='itens_importados'),
    path('compras/', compras_view, name='compras'),
    path('compra/<int:compra_id>//', detalhes_compra_view, name='detalhes_compra'),
]
